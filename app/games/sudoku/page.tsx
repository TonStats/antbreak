    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <nav aria-label="Breadcrumb" className="py-1">
        <ol className="flex flex-wrap items-center gap-x-1.5 gap-y-1 text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <li aria-hidden="true"><ChevronRight className="h-3.5 w-3.5" /></li>
          <li className="font-medium text-zinc-900 dark:text-zinc-100">Sudoku</li>
        </ol>
      </nav>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div style={{ height: 'calc(100vh - 100px)', minHeight: '600px', overflowY: 'auto' }}>
            <SudokuGame />
          </div>
        </div>
      ...
      <div className="mt-8 space-y-10 pb-10">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-zinc-900 dark:text-zinc-100">About Sudoku</h2>
